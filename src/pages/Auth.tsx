  ...
  if (step === "welcome") {
    return (
      <div className="h-[100dvh] bg-white flex flex-col items-center justify-center px-6 py-10 text-center">
        ...
        <h1 className="text-6xl font-handwritten font-normal text-black mb-3">
          ...
          {step === 'method' && (
            <div className="space-y-4">
              <div className="space-y-2 text-center">
                ...
                <h1 className="text-5xl font-handwritten font-normal text-black">{t('auth.welcomeScriptWord', 'Welcome')}</h1>
