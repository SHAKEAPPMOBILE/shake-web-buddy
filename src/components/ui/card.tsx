  ...
  "rounded-xl text-card-foreground",
  {
    variants: {
      variant: {
        ...
        activity: "border border-border bg-gradient-to-b from-card to-background shadow-xl hover:border-primary/30 hover:shadow-2xl transition-all duration-300 group cursor-pointer",
