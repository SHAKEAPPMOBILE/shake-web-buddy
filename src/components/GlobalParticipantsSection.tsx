  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/20 backdrop-blur-md border border-white/40 shadow-lg hover:bg-white/30 transition-colors cursor-pointer animate-fade-up"
